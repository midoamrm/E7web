...
app.get('/'/* path or url '/' represrnts route of the website*/, /* callback function */(req, res) => {
    ...
    res.send('Mohammed Amr Ahmed');
});


app.get('/web/students/read', (req, res) => {
    res.send(students);
});


app.get('/web/students/read/:id', (req, res) => {
...
// Updating resources
app.put('/web/students/update/:id', (req, res) => {
...
// Deleting a student
app.delete('/web/students/delete/:id', (req, res) => {
...
// to get all courses
app.get('/web/courses/read', (req, res) => {
    res.send(courses);
});



app.get('/web/courses/read/:id', (req, res) => {
...
// Updating resources
app.put('/web/courses/update/:id', (req, res) => {
    // Look up the course 
...
// Deleting a course
app.delete('/web/courses/delete/:id', (req, res) => {
    // Look up the course 
